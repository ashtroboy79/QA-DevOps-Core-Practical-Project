...
class TestMonsterClass(TestBase):
    ...
    def test_monster_class_troll1(self):
        response = self.client.post(
            ...
            json = {'monster':'Troll', 'type':1, "minions":"Orcs", "quantity":1}
        )
    ...
    def test_monster_class_troll2(self):
        response = self.client.post(
            url_for('monster_class'),
            json = {'monster':'Troll', 'type':2, "minions":"Orcs", "quantity":1}
        )
        self.assert200(response)
    ...
    def test_monster_class_troll3(self):
        response = self.client.post(
            url_for('monster_class'),
            json = {'monster':'Troll', 'type':3, "minions":"Orcs", "quantity":1}
        )
        self.assert200(response)
    ...
    def test_monster_class_troll4(self):
        response = self.client.post(
            url_for('monster_class'),
            json = {'monster':'Troll', 'type':4, "minions":"Orcs", "quantity":1}
        )
        self.assert200(response)
    ...
    def test_monster_class_troll5(self):
        response = self.client.post(
            url_for('monster_class'),
            json = {'monster':'Troll', 'type':5, "minions":"Orcs", "quantity":1}
        )
        self.assert200(response)
    ...
    def test_monster_class_troll6(self):
        response = self.client.post(
            url_for('monster_class'),
            json = {'monster':'Troll', 'type':6, "minions":"Orcs", "quantity":1}
        )
        self.assert200(response)
